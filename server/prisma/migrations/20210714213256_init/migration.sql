...
-- CreateIndex
CREATE UNIQUE INDEX "Applicant_addressId_unique" ON "Applicant"("addressId");
...
-- AddForeignKey
ALTER TABLE "Applicant" ADD FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE SET NULL ON UPDATE CASCADE;
