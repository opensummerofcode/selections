...
import { DoubleChevronRightIcon } from 'evergreen-ui';
...
const StudentCardCollapsable = ({ student }) => {
  return (
    <div className={`${styles.condensed}`}>
      <span className={styles.role}>Primary Role</span>

      <div>
        <b> Pskill, Sskill,</b> skill1, skill2, skill3, skill4,...
      </div>

      <span className={styles.role}>Secondary Role</span>
      ...
      <div className={styles.recommendations}>
        <span className={styles.recomm}>Recommendations</span>

        <ul className={styles.recommList}>
          <li className={`${styles.recommListItem}  ${styles.yes}`}>
            <span className={styles.recommCoach}>Miet</span>
            <span>Strong profile</span>
          </li>
          <li className={`${styles.recommListItem}  ${styles.maybe}`}>
            <span className={styles.recommCoach}>Michiel</span>
            <span>I have some doubts</span>
          </li>
        </ul>
      </div>
